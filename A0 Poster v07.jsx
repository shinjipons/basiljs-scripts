...
function draw() {
	...
	var limit = 200;
	var maxStrokeWeight = 800; // this is the maximum value
	...
	var frameWidth = b.width * 5;
	var moveLeft = (frameWidth/2 - b.width/2) * -1;
	var frameHeight = b.height * 5;
	var moveUp = (frameHeight/2 - b.height/2) * -1;

	b.textFont("Unifont\tMedium");
	b.textSize(200);

	for (var i = 0; i < string.length; i++) {
		shiftArray.push(b.random(-b.height, b.height));
		rotationArray.push(b.floor(b.random(-180, 180)));
		scaleArray.push(b.random(500, 700));
	}

	b.textAlign(Justification.CENTER_ALIGN, VerticalJustification.CENTER_ALIGN);

	b.layer("original");
	var myFrame = b.text(string, 0, 0, frameWidth, frameHeight);
	b.itemX(myFrame, moveLeft);
	b.itemY(myFrame, moveUp);
	...
	for (var i = limit; i > 0; i--) {
		...
		var myCopy = b.text(string, 0, 0, frameWidth, frameHeight);
		...
		b.typo(myCopy, 'endJoin', OutlineJoin.MITER_END_JOIN);
		b.typo(myCopy, 'hyphenation', false);
		b.itemX(myCopy, moveLeft);
		b.itemY(myCopy, moveUp);
