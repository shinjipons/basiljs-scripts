...
function draw() {
	...
	for (var i = 0; i < string.length; i++) {
		...
		scaleArray.push(b.random(500, 1000));
	}

	b.textAlign(Justification.CENTER_ALIGN, VerticalJustification.CENTER_ALIGN);

	b.layer("original");
	var myFrame = b.text(string, 0, 0, b.width * 2, b.height);
	...
	for (var i = limit; i > 0; i--) {
		...
		var myCopy = b.text(string, 0, 0, b.width * 2, b.height);
		...
		b.typo(myCopy, 'endJoin', OutlineJoin.MITRE_END_JOIN);
