...
function draw() {
	...
	var limit = 5;
	var contents = "Signs of true greatness";
	...
	for (var i = 0; i < myArray.length; i++) {
		...
		for (var j = 0; j < limit; j++) {
			...
			b.opacity(myFrame2, b.floor( b.map(j, 0, limit, 0, 100)));
