...
function draw() {
	...
	var limit = 5;
 	...
 	var contents = "A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine.";
	...
	for (var i = 0; i < myArray.length; i++) {
		...
		var randomSize = b.floor(b.random(100, 400));
		...
		// b.println("The width of the doc is " + b.width);
		// b.println("The right position of this word is " + b.bounds(myWords[0]).right);

		if (b.bounds(myWords[0]).right > b.width) {
			var delta = b.bounds(myWords[0]).right - b.width;
			posX = posX - delta * 1.2;
			b.itemX(myFrame, posX);
			// b.stroke(b.color(0, 0, 100, 100));
			// b.line(b.bounds(myWords[0]).right, 0, b.bounds(myWords[0]).right, b.height);
		}
