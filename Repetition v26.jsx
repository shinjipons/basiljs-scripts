...
function draw() {
	...
	for (var i = 0; i < myArray.length; i++) {
		...
		b.typo(myFrame, 'fillColor', white);

		b.typo(myFrame, 'strokeColor', b.color(0, 0, 0, 100));
		b.typo(myFrame, 'strokeWeight', 0.1);
		...
		var angle = b.constrain( b.degrees(b.acos(distX / radius)), 0, 60); // max is 85
		...
		for (var j = 0; j < limit2; j++) {
			...
			b.typo(myFrame2, 'strokeColor', b.color(0, 0, 0, 100));
			b.typo(myFrame2, 'strokeWeight', 0.1);
			b.typo(myFrame2, 'strokeAlignment', TextStrokeAlign.OUTSIDE_ALIGNMENT);
