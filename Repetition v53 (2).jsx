...
function draw() {
	...
	// var pointSizeFactor = 10/myArray.length;
	...
	for (var i = 0; i < myArray.length; i++) {
		...
		var posY = stepY * i;
		// below flooring is extremely important otherwise the script will crash
		var randomSize = 200;
		...
		var angle = b.floor( b.constrain( b.degrees( b.acos(distX / radius)), 0, 85));
		...
		for (var j = 0; j < limit; j++) {
			...
			var pointSizeMapped = b.floor( b.map(j, 0, limit, 10, randomSize));
