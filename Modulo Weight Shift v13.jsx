...
function draw() {
	...
	for (var i = 0; i < myCharacters.length; i++) {
		var myCharacters = b.characters(myFrame);
		var mappedWeight = moduloWeightArray[b.floor(b.map(i, 0, myCharacters.length, 0, moduloWeightArray.length))];
		var mappedStyle = moduloStyleArray[b.floor(b.map(i, 0, myCharacters.length, 0, moduloStyleArray.length))];
