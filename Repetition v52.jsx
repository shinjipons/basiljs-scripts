...
function draw() {
	...
	var limit = 5;
	var contents = "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.";
	...
	for (var i = 0; i < myArray.length; i++) {
		...
		var randomSize = b.floor(b.random(200, 500)) * pointSizeFactor;
