...
function draw() {
	// for this script to work, you must create a text frame and make the line breaks yourself by pressing the enter key and select the text frame before launching the script
