...
function draw() {
	...
	var limit = 5;
	var contents = "This is the London College of Communication";
	...
	for (var i = 0; i < myArray.length; i++) {
		...
		var posX = b.random(0, b.width * 0.7);
		var posY = stepY * i;
		...
		var angle = b.floor( b.constrain( b.degrees( b.acos(distX / radius) ), 0, 45) ); // max is 85
		...
		for (var j = 0; j < limit; j++) {
			...
			var opacityValue = b.map(j, 0, limit, 0, 100);
			...
			b.opacity(myFrame2, opacityValue);
