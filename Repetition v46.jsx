...
function draw() {
	...
	var limit = 5;
	var contents = "Welcome to the London College of Communication";
	...
	for (var i = 0; i < myArray.length; i++) {
		...
		var posY = stepY * i;
		var randomSize = b.floor(b.random(200, 500));
		...
		// // 4-1: applying the stroke effects
		// for (var k = 10; k > 0; k--) {
		// 	var strokeCopy = b.text(string, posX, posY, b.width, b.height);
		// 	b.typo(strokeCopy, 'fillColor', red);
		// 	b.typo(strokeCopy, 'pointSize', randomSize);
		// 	b.typo(strokeCopy, 'strokeWeight', k * 3);
		// 	b.typo(strokeCopy, 'horizontalScale', XScale);
		// 	b.typo(strokeCopy, 'verticalScale', YScale);

		// 	if (wordMiddleX <= centerX && wordMiddleY <= centerY) {
		// 		b.typo(strokeCopy, 'skew', angle);
		// 	} else if (wordMiddleX >= centerX && wordMiddleY <= centerY) {
		// 		b.typo(strokeCopy, 'skew', angle * -1);
		// 	} else if (wordMiddleX >= centerX && wordMiddleY >= centerY) {
		// 		b.typo(strokeCopy, 'skew', angle);
		// 	} else if (wordMiddleX <= centerX && wordMiddleY >= centerY) {
		// 		b.typo(strokeCopy, 'skew', angle * -1);
		...
		// 	if (k%2 == 0) {
		// 		b.typo(strokeCopy, 'strokeColor', red);
		// 	} else {
		// 		b.typo(strokeCopy, 'strokeColor', white);
		// 	}
		// }
